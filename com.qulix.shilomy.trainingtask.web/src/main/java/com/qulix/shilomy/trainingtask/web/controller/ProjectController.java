...
public class ProjectController extends HttpServlet {
    ...
    /**
     * Метод который отображает страницу формы проекта и заполняет её необходимыми для отображения данными
     * в зависимости от режима(pageMode):
     * EDIT_MODE - производится поиск и добавление проекта в форму для редактирования
     * CREATE_MODE - поля формы остаются пустыми для добавления проекта
     * @param request запрос клиента
     * @param response ответ сервера
