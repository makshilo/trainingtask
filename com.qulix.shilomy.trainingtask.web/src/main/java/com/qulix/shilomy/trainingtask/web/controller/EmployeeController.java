...
public class EmployeeController extends HttpServlet {
    ...
    /**
     * Метод который отображает страницу формы работника и заполняет её необходимыми для отображения данными
     * в зависимости от режима(pageMode):
     * EDIT_MODE - производится поиск и добавление работника в форму для редактирования
     * CREATE_MODE - поля формы остаются пустыми для добавления работника
     * @param request запрос клиента
     * @param response ответ сервера
