...
<form action="<c:url value="/controller?command=createTask"/>" method="post">
    ...
    <input required value="1" type="number" id="startDay" name="startDay" min="1" max="31" oninvalid="this.setCustomValidity('Заполните поле')" oninput="setCustomValidity('')"><br><br>
    ...
    <input required value="1" type="number" id="endDay" name="endDay" min="1" max="31" oninvalid="this.setCustomValidity('Заполните поле')" oninput="setCustomValidity('')"><br><br>
