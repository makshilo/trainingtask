...
public class EditEmployee implements Command {
    ...
    private EditEmployee(RequestFactory requestFactory, PropertyContext propertyContext) {
    ...
    public static synchronized EditEmployee getInstance(RequestFactory requestFactory, PropertyContext propertyContext) {
        if (instance == null) {
            instance = new EditEmployee(requestFactory, propertyContext);
        }
        return instance;
    }
